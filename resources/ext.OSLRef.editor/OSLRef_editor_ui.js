...
OSLRef.editor.prototype.addCss = function () {
...
OSLRef.editor.createModal = function (config) {
    config = config || {}
    var defaultConfig = {
        "size": "lg",
        "class": "",
...
OSLRef.editor.prototype.alert = function (msg) {
    let msg_confirm = "OK";
    const promise = new Promise((resolve, reject) => {
        const confirmClose_modal = OSLRef.editor.createModal({
...
OSLRef.editor.prototype.confirm = function (msg) {
...
OSLRef.editor.prototype.createPopupDialog = function (_config) {
    _config = _config || {}
    var editor = this;
    var defaultConfig = {
...
OSLRef.editor.prototype.createPopupDialog_old = function (_config) {
    _config = _config || {}
    var editor = this;
    var defaultConfig = {
        size: "medium", //small, medium, large, larger or full,
    ...
    Dialog.prototype.getActionProcess = function (action) {
        ...
        if (action === 'cancel') { // "Cancel or ESC pressed"
            return new OO.ui.Process(function () {
                ...
                return;
                const modal = OSLRef.editor.createModal({
...
*/
OSLRef.editor.createAutocompleteInput = function (config) {
